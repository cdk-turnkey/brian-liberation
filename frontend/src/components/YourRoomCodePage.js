      ...
      (d) => {
        ...
        if (d.status === 200) {
          ...
          if (d.err === Configs.generic400ErrorMessage) {
            this.setState({
              failureMessage:
                "We could not join you to your own sesh with that Game Name. " +
    ...
    let spinnerOrRoomCode = (
      <div>
        ...
        <Typography component="p">
          Tell everyone at your sesh to go to{" "}
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://brian-liberation.com"
          >
            brian-liberation.com
          </a>{" "}
          (opens in a new tab) on their computer or mini-computer, click "Join a
          Sesh", and enter that Room Code to join you virtually.
        </Typography>
        <br />
        <div>
          <Divider />
        ...
        <div>
          <Typography component="p" paragraph gutterBottom>
            ...
            you, personally, will be known throughout this sesh.
          </Typography>
        </div>
        <div>
          <TextField
